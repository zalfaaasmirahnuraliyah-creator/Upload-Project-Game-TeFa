...
gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.idToCallbackMap = new Map();
...
{isConditionTrue_0 = (eventsFunctionContext.getArgument("AudioType") == "Sound");
}
...
{gdjs.evtTools.sound.setSoundOnChannelVolume(runtimeScene, eventsFunctionContext.getArgument("Channel"), gdjs.evtTools.common.lerp(eventsFunctionContext.getArgument("MinVol"), eventsFunctionContext.getArgument("MaxVol"), Math.max((eventsFunctionContext.getArgument("MaxDistance") - gdjs.evtTools.common.distanceBetweenPositions((( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getY()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getY()))) / eventsFunctionContext.getArgument("MaxDistance"), 0)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = (eventsFunctionContext.getArgument("AudioType") == "Music");
}
if (isConditionTrue_0) {
gdjs.copyArray(eventsFunctionContext.getObjects("Source"), gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1);
gdjs.copyArray(eventsFunctionContext.getObjects("Target"), gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1);
{gdjs.evtTools.sound.setMusicOnChannelVolume(runtimeScene, eventsFunctionContext.getArgument("Channel"), gdjs.evtTools.common.lerp(eventsFunctionContext.getArgument("MinVol"), eventsFunctionContext.getArgument("MaxVol"), Math.max((eventsFunctionContext.getArgument("MaxDistance") - gdjs.evtTools.common.distanceBetweenPositions((( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDSourceObjects1[0].getY()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getX()), (( gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1.length === 0 ) ? 0 :gdjs.evtsExt__VolumeFalloff__SetVolumeFalloff.GDTargetObjects1[0].getY()))) / eventsFunctionContext.getArgument("MaxDistance"), 0)));
}
}
...
, "Target": gdjs.objectsListsToArray(Target)
  ...
  globalVariablesForExtension: runtimeScene.getGame().getVariablesForExtension("VolumeFalloff"),
  sceneVariablesForExtension: runtimeScene.getScene().getVariablesForExtension("VolumeFalloff"),
  localVariables: [],
