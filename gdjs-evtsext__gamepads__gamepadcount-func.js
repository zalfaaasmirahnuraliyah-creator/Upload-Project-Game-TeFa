...
gdjs.evtsExt__Gamepads__GamepadCount.idToCallbackMap = new Map();


gdjs.evtsExt__Gamepads__GamepadCount.userFunc0xccd0f0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
...
for (let playerId = 0; playerId < gamepads.length; playerId++) {
    ...
    if (gamepads[playerId]) {
        lastGamepadIndex = playerId
    }
}
eventsFunctionContext.returnValue = lastGamepadIndex + 1;
};
...
gdjs.evtsExt__Gamepads__GamepadCount.userFunc0xccd0f0(runtimeScene, eventsFunctionContext);
