...
gdjs.evtsExt__Enemy__TriggerFlyDeath.idToCallbackMap = new Map();
...
{for(var i = 0, len = gdjs.evtsExt__Enemy__TriggerFlyDeath.GDFlyObjects1.length ;i < len;++i) {
    gdjs.evtsExt__Enemy__TriggerFlyDeath.GDFlyObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("ShakeObject_PositionAngle")).ShakeObject_PositionAngle(300, 0, 0, 30, 0.3, true, eventsFunctionContext);
}
}
{for(var i = 0, len = gdjs.evtsExt__Enemy__TriggerFlyDeath.GDFlyObjects1.length ;i < len;++i) {
